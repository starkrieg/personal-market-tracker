...
raw_storage_path = base_storage_path + 'raw\\'
...
def scrape(website_url, ticket):
    ...
    raw_today_storage_path = raw_storage_path + f'{today}\\'
    ...
    raw_today_ticket_path = raw_today_storage_path + f'{ticket}\\'
    ...
    raw_today_ticket_website_file_path = raw_today_ticket_path + f'{sanitized_website}.html'
